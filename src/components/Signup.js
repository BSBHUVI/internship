...
function Signup() {
  ...
  <form >
    <div className="field">
      ...
      <input value={email}  onChange={(e)=>{setEmail(e.target.value)}} autoComplete="off"   id="logemail" placeholder="Email" className="input-field" name="logemail" type="email"/>
    </div>
    <div className="field">
      <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <span className='title' >Already have an Account <Link to="/internship/login">LOG IN</Link></span>
